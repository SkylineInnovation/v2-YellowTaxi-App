...
interface SimpleRideBookingScreenProps {
  navigation: any;
}

const SimpleRideBookingScreen: React.FC<SimpleRideBookingScreenProps> = ({ navigation }) => {
...
export default SimpleRideBookingScreen;
